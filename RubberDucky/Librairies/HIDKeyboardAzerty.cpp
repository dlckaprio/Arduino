 ...
 * report. 
 ****************************************************************************/
void HIDKeyboardAz::pressKey(uint8_t modifier, uint8_t key) 
{
	this->buf[0] = modifier;
 ...
 ****************************************************************************/
void HIDKeyboardAz::pressKey(uint8_t key) 
{
 ...
 ***************************************************************************/
void HIDKeyboardAz::pressSpecialKey(uint8_t modifier, uint8_t specialKey) 
{
	this->buf[0] = modifier;
 ...
 ****************************************************************************/
void HIDKeyboardAz::pressSpecialKey(uint8_t specialKey) 
{
	if(specialKey <= 0x08)
	{
 ...
 * in order. 
 ****************************************************************************/
void HIDKeyboardAz::print(char* sequence)
{	
	int i = 0;
	while(sequence[i] != '\0') 
	{
 ...
 ****************************************************************************/
void HIDKeyboardAz::println(char* sequence)
{	
	print(sequence);
